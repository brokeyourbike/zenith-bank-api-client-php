...
namespace BrokeYourBike\ZenithBank\Tests\Enums;
 ...
 */
class PostedStatusEnumTest extends TestCase
{
    /** @test */
    public function it_extends_myclabs_enum(): void
    {
        $parent = get_parent_class(PostedStatusEnum::class);
    ...
    {
        $allValuesRaw = PostedStatusEnum::toArray();
